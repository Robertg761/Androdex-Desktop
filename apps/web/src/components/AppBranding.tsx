...
export function AppNewThreadHero({
  ...
  return (
    ...
    >
      ...
      {projectName ? (
        <div className="liquid-glass-control mt-4 inline-flex max-w-full items-center gap-2 rounded-md border border-border/65 bg-card/80 px-3 py-2 text-sm font-medium text-foreground shadow-[0_1px_2px_rgb(0_0_0_/_0.05)] backdrop-blur">
