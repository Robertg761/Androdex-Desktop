...
export const ComposerCommandMenu = memo(function ComposerCommandMenu(props: {
  ...
  return (
    ...
    >
      <div
        ref={listRef}
        className="liquid-glass-surface liquid-glass-surface-floating relative overflow-hidden rounded-lg border border-border/80 bg-popover/96 shadow-[0_12px_40px_rgb(0_0_0_/_0.12)] backdrop-blur-xs"
      >
